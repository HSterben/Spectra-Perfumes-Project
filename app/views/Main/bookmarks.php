...
<div class='container'>
    ...
    <table>
        <?php if (!empty($data['data'])): ?>
            <?php foreach ($data['data'] as $invoice): ?>
                <div class="invoice-container">
                    <span class="invoice-id"><?= $invoice->invoice_id ?></span>
                    <span class="invoice-title"><a href='/Invoice/index/<?= $invoice->invoice_id ?>' class="invoice-title"><?= $invoice->invoice_title ?></a></span>
