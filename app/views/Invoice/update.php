...
<div class='container'>
    <form method='post' action=''><br>
        ...
        <div class="form-group">
            <label><?= __('Perfume Price:')?><input type="number" class="form-control" name="perfume_price" placeholder="12345"
        ...
        <div class="dynamic" id="dynamic">
            ...
            foreach ($perfumeOrders as $index => $perfume) {
                echo "<div class='form-group'><label><?= __('Perfume Code:')?><input type='number' class='form-control' name='perfume_number[]' placeholder='12345' id='pcode$index' value='" . $perfume->perfume_number . "' required /></label>";
                echo "<label><?= __('Perfume Quantity:')?><input type='number' class='form-control' name='quantity[]' placeholder='12345' id='quantity$index' value='" . $perfume->quantity . "' required /></label></div>";
            }
            ?>
        </div>
